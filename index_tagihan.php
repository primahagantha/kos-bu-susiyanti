...
<head>
    ...
    <title>Kos Bu Susiyanti - Tambah Tagihan</title>
    <!-- Judul halaman web -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-10">
                ...
                <div class="col-lg-12 text-center mt-5 mb-5">
                    ...
                    <h3 class="display-4">Tambah Data Tagihan</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="tambah_tagihan.php" method="post">
                            <!-- Form untuk mengirim data ke tambah_tagihan.php dengan metode POST -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jumlah_tagihan" name="jumlah_tagihan" required>
                                <!-- Input untuk jumlah tagihan, wajib diisi (required) -->
                            </div>
                            <div class="form-group">
                                <label for="keterangan_pembayaran">Keterangan Pembayaran:</label>
                                <input type="text" class="form-control" id="keterangan_pembayaran" name="keterangan_pembayaran" required>
