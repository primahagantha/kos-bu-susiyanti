...
<head>
    ...
    <title>Kos Bu Susiyanti - Edit Penyewa</title>
    <!-- Judul halaman web -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-10">
                ...
                <div class="col-lg-12 text-center mt-5 mb-5">
                    ...
                    <h3 class="display-4">Edit Data Penyewa</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        include "koneksi.php";
                        $no = $_GET['no'];
                        $stmt = $conn->prepare("SELECT * FROM nama_penyewa WHERE no=?");
                        ...
                        $stmt->close();
                        ?>
                        <form action="proses_edit_penyewa.php" method="post">
                            <!-- Form untuk mengirim data ke proses_edit_penyewa.php dengan metode POST -->
                            ...
                            <div class="form-group">
                                ...
                                value="<?php echo htmlspecialchars($data['nama_penyewa']); ?>" required>
                                <!-- Input untuk nama penyewa, wajib diisi (required) -->
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="lantai" name="lantai" value="<?php echo htmlspecialchars($data['lantai']); ?>" required>
                                <!-- Input untuk lantai, wajib diisi (required) -->
                            </div>
                            <div class="form-group">
