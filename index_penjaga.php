...
<head>
    ...
    <title>Kos Bu Susiyanti - Tambah Penjaga</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <div class="form-container">
                    <a href="daftar_penjaga.php" class="btn-back">
                        <i class="fas fa-arrow-left"></i> &lt;- Kembali
                    </a>
                    <h3>Tambah Data Penjaga</h3>
                    ...
                    <form action="tambah_penjaga.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_penjaga" name="nama_penjaga" required placeholder="Masukkan Nama Penjaga">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="jadwal_kerja" name="jadwal_kerja" required placeholder="Masukkan Jadwal Kerja">
                        </div>
