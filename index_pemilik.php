...
<head>
    ...
    <title>Kos Bu Susiyanti - Tambah Pemilik</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <div class="form-container">
                    <a href="daftar_pemilik.php" class="btn-back">
                    ...
                    <form action="tambah_pemilik.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_pemilik" name="nama_pemilik" required placeholder="Masukkan Nama Pemilik">
                        </div>
